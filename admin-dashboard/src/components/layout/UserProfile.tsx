...
export const UserProfile = ({
  ...
  return (
    <div className={`flex items-center gap-3 rounded-lg p-2 ${className}`}>
      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-amber-500/30 bg-amber-500/10 font-bold text-amber-400 text-sm">
        SD
